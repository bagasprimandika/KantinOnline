    ...
    <table id="main">
        <tr>
            <td colspan="2" style="background-color: #acacac; align:center;">
                <p style="color: #0b3005;"><b>KANTIN ONLINE</b></p>
                {{-- <img src="{{  public_path() }}/dist/img/logo6.png" alt=""> --}}
                <h4 id="no_pesanan" style="margin-top: -15px; font-size: 20px; align:center;">{{ $pesanan->no_pesanan }}
                </h4>
        ...
        <tr>
            ...
            <td>
                <span
                    id="alamat_penerima">{{ $pesanan->pengiriman->alamat_penerima . ', Kec. ' . ucwords(strtolower($pesanan->pengiriman->kecamatan->nama_kec)) . ', Kab. ' . ucwords(strtolower($pesanan->pengiriman->kabupaten->nama_kab)) }}</span>
            </td>
        </tr>
    </table>
    <table id="main">
        ...
        @foreach ($detail as $item)
            <tr>
                ...
                <td width='60%' style="text-align: center; text-transform: capitalize;">
        ...
        <tr>
            ...
            <td style="text-align: center;"> <b id="total" style="text-align: center;">Rp.
                    {{ number_format($pesanan->total, 0, ',', '.') }}</b></td>
        </tr>
    </table>
</body>
