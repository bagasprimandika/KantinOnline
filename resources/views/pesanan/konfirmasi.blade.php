                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="javascript:;" data-image="{{ $row->bukti_bayar }}"
                                            data-id="{{ $row->order_no }}" data-toggle="modal" data-target="#imgPreview"
                                            class="btn btn-sm btn-style px-3 modal-image">
                                    ...
                                    <td>
                                        <form action="{{ route('konfirmasi_pembayaran', $row->no_pesanan) }}"
                                            ...
                                            @method('PUT')
                                            @csrf
                                            <button class="btn btn-style btn-sm tombol-status"><i
