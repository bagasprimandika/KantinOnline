            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-capitalize bg-light" id="nama_penerima"
                            name="nama_penerima" value="{{ $invoice->pesanan->pengiriman->nama_penerima }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="notelp_penerima" class="font-weight-normal">No.Telp Penerima</label>
                        <input type="text" class="form-control bg-light" id="notelp_penerima" name="notelp_penerima"
                            value="{{ $invoice->pesanan->pengiriman->notelp_penerima }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="kab" class="font-weight-normal">Kapubaten Pengiriman</label>
                        <input type="text" class="form-control bg-light" id="kab" name="kab"
                            value="{{ $invoice->pesanan->pengiriman->kabupaten->nama_kab }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="kec" class="font-weight-normal">Kecamatan Pengiriman</label>
                        <input type="text" class="form-control bg-light" id="kec" name="kec"
                            value="{{ $invoice->pesanan->pengiriman->kecamatan->nama_kec }}" disabled>
                    </div>
                    <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-light" id="subtotal" name="subtotal"
                                value="{{ number_format($invoice->pesanan->subtotal, 0, ',', '.') }}" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="ongkir" class="col-sm-3 col-form-label font-weight-normal">Ongkir</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-light" id="ongkir" name="ongkir"
                                value="{{ number_format($invoice->pesanan->ongkir, 0, ',', '.') }}" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control bg-light" id="total" name="total"
                                value="{{ number_format($invoice->total, 0, ',', '.') }}" disabled>
                        </div>
                    </div>
