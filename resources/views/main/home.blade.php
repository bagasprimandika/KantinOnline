                ...
                <div class="col-lg-12">
                    <div class="hero__item set-bg" data-setbg="{{ asset('/template/img/hero/banner1.jpg') }}">
                        <div class="hero__text">
                            <h2>MAKANAN <br />DAN MINUMAN <br />100% HALAL</h2>
                            <p>Tersedia Pengiriman Berbagai Wilayah karawang Timur</p>
                        ...
                        <div class="featured__item">
                            ...
                            <div class="featured__item__text">
                                <h6 class="text-capitalize"><a
                                        href="{{ url('/shop/detail-produk/' . $item->id) }}">{{ $item->nama_produk }}</a>
                                </h6>
