                ...
                <div class="col-lg-12">
                    ...
                    <div class="shoping__cart__table">
                        <table>
                                        ...
                                        <tr>
                                            <td class="shoping__cart__item">
                                                ...
                                                <h5 class="text-capitalize"><a
                                                        href="{{ route('detail_produk', $item->produk->id) }}"
                                                        class="text-decoration-none text-dark">{{ $item->produk->nama_produk }}</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td class="shoping__cart__item__close">
                                                <form action="{{ route('delete_qty', $item->id) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button class="icon_close border-0 rounded-circle btn btn-light"
                                                        type="submit"></button>
                                                </form>
                                            </td>
                                        </tr>
                            ...
                            @else
                                <tbody>
                                    <td colspan="4">Tidak Ada Product Dalam Keranjang</td>
                                </tbody>
                            @endif
                        </table>
                    </div>
