                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="{{ url('/shop') }}" method="POST">
                                ...
                                <input type="text" placeholder="Cari Toko..." autocomplete="off" name="keyword"
                                    class="text-dark" value="{{ $keyword != null ? $keyword : '' }}">
