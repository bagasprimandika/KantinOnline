                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('update_password') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password"
                                            class="form-control @error('password2') border border-danger @enderror"
                                            id="password2" name="password2" autocomplete="off">
                                        @error('password2')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="accordion mt-4" id="faqExample">
                                    ...
                                    <div class="card mt-3">
                                        <div class="card-header p-2 st-color" id="headingThree">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link text-light collapsed" type="button"
                                                    ...
                                                    Q. Bagaimana pesanan kami dapat diterima?
                                                </button>
                                            </h5>
                                        </div>
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            data-parent="#faqExample">
                                            <div class="card-body">
                                                <b>Answer:</b> Kantin Online menyediakan jasa pengiriman sesuai dengan harga
                                                dari masing-masing penjual yang sudah ditentukan sesuai lokasi customer
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-3">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                            ...
                                            <div class="card-body">
                                                ...
                                                dikonfirmasi oleh admin dan penjual dari pukul 10.00 AM - 09.00 PM
                                            </div>
                                        </div>
                                    </div>
                                </div>
