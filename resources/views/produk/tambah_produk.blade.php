                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nama_produk" class="text-dark">Nama </label>
                            <input type="text" class="form-control @error('nama_produk') is-invalid @enderror"
                                id="nama_produk" name="nama_produk" autocomplete="off" value="{{ old('nama_produk') }}"
                                autofocus>
                            @error('nama_produk')
                        ...
                        <div class="form-group">
                            <label for="desc_produk" class="tex">Deskripsi</label>
                            @error('desc_produk')
                                <div class=" invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body">
                        <div class="custom-control custom-switch">
                            ...
                            <label class="custom-control-label text-primary font-weight-bolder" for="customSwitches"
                                id="labelStock">Stock Tersedia</label>
                        </div>
                    </div>
                </div>
                <div class="card mt-3">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="harga_produk" class="text-dark">Harga </label>
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                <label for="foto_produk" class="text-dark mt-3">Foto </label>
                                <input type="file" class="input-file" id="foto_produk" name="foto_produk"
                                    onchange="previewImage()">
                                <h6 class="text-center font-weight-bolder mt-3">Preview Foto </h6>
                                <hr>
                                <img src="" class="tengah img-preview img-fluid mb-3 tengah"
