...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <h1 class="h3 mb-0 text-gray-800">Master Data Makanan dan Minuman</h1>
        <a href="/produk/create" class="btn btn-style float-right"><i class="fas fa-fw fa-plus"></i> Tambah Data Makanan dan
            Minuman</a>
    </div>
                    ...
                    <table class="table table-striped table-bordered" id="mytabel" width="100%">
                        <thead>
                            <tr class="text-center">
                                <th scope="col">No.</th>
                                <th scope="col">Makanan dan Minuman</th>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <form action="{{ route('update_stock', $row->id) }}" method="POST"
                                            ...
                                            @else
                                                <button class="btn btn-success btn-sm tombol-stock"
                                                    data-stock="{{ $row->stock_produk }}"><i
                                                        class="fas fa-fw fa-arrow-circle-up"></i></button>
                                            @endif
                                        </form>
                                        <a href="{{ url('produk/' . $row->id) }}/edit" class="btn btn-primary btn-sm"><i
