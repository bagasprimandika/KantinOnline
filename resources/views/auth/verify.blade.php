...
<body style="background-color: #0B3005">
    <div class="container">
        <div class="row d-flex justify-content-center mt-5">
            <div class="col-md-6">
                <div class="card mt-5">
                    <div class="card-header font-weight-bolder ">{{ __('VERIFIKASI EMAIL AKUN KANTIN ONLINE') }}</div>
                    ...
                    <div class="card-body px-4 pb-5">
                        ...
                        <img src="/dist/img/logo6.png" width="80%" class="tengah shadow-sm p-3 mb-2 bg-white rounded"
                            alt="">
                        ...
                        <form class="d-flex justify-content-center mt-3" method="POST"
                            ...
                            @csrf
                            <button type="submit"
                                class="btn btn-style align-baseline px-3 py-2  shadow-sm rounded">Kirim Ulang
                                Email</button>
                        </form>
                    </div>
                </div>
