                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('register_seller') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('nama_toko') is-invalid @enderror" id="nama_toko"
                                                name="nama_toko" autocomplete="off" value="{{ old('nama_toko') }}"
                                                autofocus>
                                            @error('nama_toko')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('notelp_toko') is-invalid @enderror"
                                                id="notelp_toko" name="notelp_toko" autocomplete="off"
                                                value="{{ old('notelp_toko') }}" autofocus>
                                            @error('notelp_toko')
                                                <div class=" invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control @error('alamat_toko') border border-danger @enderror" id="alamat_toko" rows="2"
                                                name="alamat_toko" autocomplete="off"></textarea>
                                            @error('alamat_toko')
                                ...
                                <div class="accordion mt-4" id="faqExample">
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body">
                                                <b>Answer:</b> Kantin Online adalah toko online yang dapat digunakan untuk
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                            ...
                                            <div class="card-body">
                                                ...
                                                harga dari masing-masing penjual makanan dan minuman yang sudah ditentukan
                                                sesuai lokasi
                                                customer
                                            </div>
                                        </div>
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                            data-parent="#faqExample">
                                            <div class="card-body">
                                                <b>Answer:</b> Kanrin Online dapat menerima pesana 24 jam, namun akan
                                                dikonfirmasi oleh admin dan penjual dari pukul 07.00 AM - 17.00 PM
                                            </div>
                                        </div>
                                    </div>
                                </div>
