...
<head>
    ...
    <title>REGISTRASI KANTIN ONLINE</title>
                ...
                <div class="card">
                    <div class="px-4 py-5">
                        <div class=" card-body p-0">
                            <h2 style="font-size: 30px; color: #0B3005" class="text-center"><i
                                    class="fa-solid fa-user"></i> REGISTRASI</h2>
                            <hr class="garis">
                                ...
                                <div class="mb-3">
                                    <div class="input-group @error('notelp') is-invalid @enderror">
                                        ...
                                        <input type="text" class="form-control @error('notelp') is-invalid @enderror"
                                            id="notelp" name="notelp" autocomplete="off" value="{{ old('notelp') }}"
                                            placeholder="No. Telp">
                                    </div>
                                    @error('notelp')
                                        <div class=" invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control" placeholder="Konfirmasi Password"
                                            id="password-confirm" name="password_confirmation" autocomplete="off">
                                    </div>
                                </div>
